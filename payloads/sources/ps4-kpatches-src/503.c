...
static inline void do_patch(void *kbase) {
    ...
    write8(kbase, 0xabd, 0xeb); // bcopy
    write8(kbase, 0x1ea47d, 0xeb); // bzero
    write8(kbase, 0x1ea4c1, 0xeb); // pagezero
    write8(kbase, 0x1ea53d, 0xeb); // memcpy
    write8(kbase, 0x1ea581, 0xeb); // pagecopy
    write8(kbase, 0x1ea71d, 0xeb); // copyin
    write8(kbase, 0x1eab4d, 0xeb); // copyinstr
    write8(kbase, 0x1eac0d, 0xeb); // copystr
    ...
    write8(kbase, 0x4c5, 0xeb);
    write16(kbase, 0x4bc, 0x00eb);
    write16(kbase, 0x4b8, 0x00eb);
    ...
    //     mov     rbp, rsp
    //     ...
    write32(kbase, 0x2b2620, 0xc3c03148);
    ...
    write8(kbase, 0x13d620, 0x37);
    write8(kbase, 0x13d623, 0x37);
    ...
    // }
    const u64 sysent_11_off = 0x107c820;
    // .sy_narg = 2
    write32(kbase, sysent_11_off, 2);
    // .sy_call = gadgets['jmp qword ptr [rsi]']
    write64(kbase, sysent_11_off + 8, kbase + 0x13460);
