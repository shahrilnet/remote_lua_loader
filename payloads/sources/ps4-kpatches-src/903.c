...
static inline void do_patch(void *kbase) {
    ...
    write16(kbase, 0x271377, 0x9090); // copyin 1
    write16(kbase, 0x271383, 0x9090); // copyin 2
    write8(kbase, 0x271385, 0x90); // copyin 2
    ...
    write16(kbase, 0x271860, 0x9090); // copyinstr 3
