...
static inline void do_patch(void *kbase) {
    ...
    write8(kbase, 0x472d2d, 0xeb); // memcpy
    write8(kbase, 0x472d71, 0xeb); // pagecopy
    ...
    write64(kbase, sysent_11_off + 8, kbase + 0x68b1);
