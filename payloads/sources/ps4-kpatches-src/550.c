...
static inline void do_patch(void *kbase) {
    ...
    write8(kbase, 0x40590d, 0xeb); // bzero
    write8(kbase, 0x405951, 0xeb); // pagezero
    write8(kbase, 0x4059cd, 0xeb); // memcpy
    write8(kbase, 0x405a11, 0xeb); // pagecopy
    write8(kbase, 0x405bbd, 0xeb); // copyin
    write8(kbase, 0x40606d, 0xeb); // copyinstr
    write8(kbase, 0x40613d, 0xeb); // copystr
    ...
    //     mov     rbp, rsp
    //     ...
    write32(kbase, 0x400130, 0xc3c03148);
    ...
    write8(kbase, 0x3c25d9, 0x37);
    write8(kbase, 0x3c25dc, 0x37);
