...
static inline void do_patch(void *kbase) {
    ...
    write8(kbase, 0x1ea36d, 0xeb); // bzero
    write8(kbase, 0x1ea3b1, 0xeb); // pagezero
    write8(kbase, 0x1ea42d, 0xeb); // memcpy
    write8(kbase, 0x1ea471, 0xeb); // pagecopy
    write8(kbase, 0x1ea60d, 0xeb); // copyin
    write8(kbase, 0x1eaa3d, 0xeb); // copyinstr
    write8(kbase, 0x1eaafd, 0xeb); // copystr
    ...
    //     mov     rbp, rsp
    //     ...
    write32(kbase, 0x2b2350, 0xc3c03148);
    ...
    write8(kbase, 0x13d510, 0x37);
    write8(kbase, 0x13d513, 0x37);
